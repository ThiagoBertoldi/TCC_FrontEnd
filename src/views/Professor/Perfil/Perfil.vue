<template>
   ...
   <div v-if="user" class="container d-flex justify-center align-center">
      <v-col cols="4">
         <v-card>
            <div class="d-flex justify-center">
               <img :src="imgUser" width="150" height="150" />
            </div>
...
export default {
   ...
   computed: {
      getTipoUser() {
         return `Você é um ${this.user.type === 1 ? 'Professor' : 'Aluno'} `
      }
   },
   beforeCreate() {
      this.$api.get('get-user', {})
      .then(response => {
